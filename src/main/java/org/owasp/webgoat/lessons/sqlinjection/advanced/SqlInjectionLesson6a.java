...
public class SqlInjectionLesson6a implements AssignmentEndpoint {
  ...
  public AttackResult injectableQuery(String accountName) {
    // The account name is bound as a parameter, so it is always compared as a single last name and
    // can never append a UNION or a second statement to the query.
