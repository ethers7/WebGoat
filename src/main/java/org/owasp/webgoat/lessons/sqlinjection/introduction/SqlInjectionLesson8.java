...
public class SqlInjectionLesson8 implements AssignmentEndpoint {
  ...
  protected AttackResult injectableQueryConfidentiality(String name, String auth_tan) {
    ...
    // The name and the TAN are bound as parameters, so they are always compared as data and can
    // never change the structure of the statement.
  ...
  public static void log(Connection connection, String action) {
    ...
    // The logged action is bound as a parameter, so a crafted action can never break out of the
    // string literal and turn this INSERT into additional statements.
