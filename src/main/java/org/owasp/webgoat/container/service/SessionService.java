...
public class SessionService {
  ...
  /**
   * Toggles the security setting of the session, which is server side state, so it only accepts
   * POST and cannot be triggered through a link or an image loaded from another site.
   */
