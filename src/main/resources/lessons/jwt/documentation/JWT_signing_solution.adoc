...
// Lesson sample only: the access_token below is demo output of this local lesson, expired and not a live credential.
[source]
----
...
// Lesson sample only: the unsigned token below is demo output of this local lesson, not a live credential.
[source]
----
