...
public class SqlInjectionAdvancedIntegrationTest extends IntegrationTest {
  ...
  public void runTests() {
    ...
    // The account name of assignment 6a is bound as a parameter, so the classic injections are
    // matched as literal account names and no longer disclose a password.
    params.clear();
