...
public class SqlInjectionLesson13Test extends LessonTest {
  ...
  @Test
  public void knownColumnShouldOrderByThatColumn() throws Exception {
    mockMvc
        .perform(
  ...
  @Test
  public void injectedCaseExpressionShouldBeRejected() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/SqlInjectionMitigations/servers")
                .param(
  ...
  @Test
  public void injectedSubstrExpressionShouldBeRejected() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/SqlInjectionMitigations/servers")
                .param(
  ...
  @Test
  public void injectedBooleanExpressionShouldBeRejected() throws Exception {
    mockMvc
        .perform(
            MockMvcRequestBuilders.get("/SqlInjectionMitigations/servers")
